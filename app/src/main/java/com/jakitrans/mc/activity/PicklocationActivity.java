...
public class PicklocationActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String OnlineKey = MainActivity.apikey;
        String InternalKey = getString(R.string.google_maps_key);
        if(OnlineKey == null){
            Places.initialize(getApplicationContext(), InternalKey);
            Places.createClient(this);
            if (!Places.isInitialized()) {
                Places.initialize(getApplicationContext(),InternalKey);
            }
        }else{
            Places.initialize(getApplicationContext(), OnlineKey);
            Places.createClient(this);
            if (!Places.isInitialized()) {
                Places.initialize(getApplicationContext(), OnlineKey);
            }
