...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextView countryCode, sendTo, textnotif, textnotif2, privacypolicy, opentime, closetime, merchantloc,mercpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mercpassword = findViewById(R.id.password);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phone.getText().toString())) {
                    ...
                    notif("Jam Buka Tidak Boleh Kosong!");
                } else if (TextUtils.isEmpty(closetime.getText().toString())) {
                    notif("Jam Tutup Tidak Boleh Kosong!");
                } else if (TextUtils.isEmpty(mercpassword.getText().toString())) {
    ...
    private void upload(final String check) {
        ...
        request.setPassword(mercpassword.getText().toString());
            ...
            public void onResponse(Call<PrivacyResponseJson> call, Response<PrivacyResponseJson> response) {
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("found")) {
                        ...
                        cekOtp = model.getIsOtp();
                        Log.e("Tag.Registrasi",cekOtp + "");
                    }
                }
            }
