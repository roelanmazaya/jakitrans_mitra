...
import com.jakitrans.mc.utils.AppIntroPagerAdapter;
import com.jakitrans.mc.utils.ProjectUtils;
import com.jakitrans.mc.utils.SharedPrefrence;
...
public class IntroActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    Button buttonSign;
    int[] mResources = {R.drawable.intro} ;
