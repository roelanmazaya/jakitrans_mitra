...
import com.jakitrans.mc.activity.MenuActivity;
...
public class CategoryItem extends RecyclerView.Adapter<CategoryItem.ItemRowHolder> {
    ...
    private List<KategoriItemModel> dataList;
    private Context mContext;
    private int rowLayout;

    public CategoryItem(Context context, List<KategoriItemModel> dataList, int rowLayout) {
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        final KategoriItemModel singleItem = dataList.get(position);
